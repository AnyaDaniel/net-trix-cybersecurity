"use client";
import Training from "@/components/services/main/Training";
...
import Compliance from "@/components/services/main/Compliance";
import Incident from "@/components/services/main/Incident";
import Soc from "@/components/services/main/Soc";
        ...
        {isTablet ? (
          ...
          >
            <ProjectCard
              ...
              cls="overflow-hidden rounded-lg shadow-lg border border-[#2A0E61] w-1/3 w-[30.6vw] ml-[2vw] h-[50vh]"
            />
          </ParallaxLayer>
        ) : (
        ...
        {isTablet ? (
          ...
          >
            <ProjectCard
              ...
              cls="overflow-hidden rounded-lg shadow-lg border border-[#2A0E61] w-1/3 w-[30.6vw] ml-[34.6vw] h-[50vh]"
            />
          </ParallaxLayer>
        ) : (
          <div className="w-full pt-0">
        ...
        {isTablet ? (
          ...
          >
            <ProjectCard
              ...
              cls="overflow-hidden rounded-lg shadow-lg border border-[#2A0E61] w-1/3 w-[30.6vw] ml-[67.2vw] h-[50vh]"
            />
          </ParallaxLayer>
        ) : (
          <div className="w-full pt-0">
