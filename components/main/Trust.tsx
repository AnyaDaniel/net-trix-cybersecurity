      ...
      <div className="py-10 md:py-40 bg-[url('/trustbg.jpg')] bg-cover">
        <div className="px-10 md:px-32 text-center">
          ...
          <p className="text-lg text-gray-200">
            At Net Trix Solutions, We capitalize on our robust collaboration with leading global cybersecurity experts. to deliver top-tier solutions. Through this collaboration, we provide access to latest cutting-edge technologies and tools, ensuring our clients benefit from the best in cybersecurity.
          </p>
        </div>
