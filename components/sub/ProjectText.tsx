...
const ProjectText = () => {
  return (
    <ParallaxLayer offset={5}>
      <div className="flex flex-col justify-center items-center md:flex-row md:px-20 px-4 py-20">
        <motion.div
          variants={slideInFromTop}
          className="flex flex-col gap-6 mt-6 text-5xl text-white w-full"
        >
          <h1 className="text-5xl md:pl-20">
            {" "}
            Data Protection and
